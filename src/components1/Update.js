...
function Update() {
  ...
  const handleUpdate = () => {
    ...
    const url = `${BACKEND_URL}/signup/update`;
    axios
  ...
  const delete1 = () => {
    ...
    if (shouldDelete) {
      ...
      const url = `${BACKEND_URL}/signup/update/${username}`;
      axios
        .delete(url)
        .then((res) => {
          if (res.status === 200) {
      ...
      axios
        ...
        .delete(`${BACKEND_URL}/data/deleteTasks`, {
          data: {
            username: username,
          },
        })
      ...
      axios
        ...
        .delete(`${BACKEND_URL}/history/deleteTasks1`, {
          data: {
            username: username,
          },
        })
  ...
  useEffect(() => {
    ...
    const url = `${BACKEND_URL}/signup/profile`;
    axios
      .post(url, obj)
      .then((res) => {
        if (res.status === 200) {
